...
-- Tactic: TACTIC_ID = '2026098CTU', SUBSTRING(TACTIC_DECISN_VRB_INFO, 121, 30) LIKE '%MB%'
-- Run in: Starburst
-- =============================================================================
...
SELECT
    ...
    (SELECT COUNT(DISTINCT CLNT_NO)
     FROM DG6V01.TACTIC_EVNT_IP_AR_HIST
     WHERE TACTIC_ID = '2026098CTU'
       AND SUBSTRING(TACTIC_DECISN_VRB_INFO, 121, 30) LIKE '%MB%')             AS total_population,
