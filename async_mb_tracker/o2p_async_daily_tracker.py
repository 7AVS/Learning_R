# =============================================================================
# O2P Async Banner — Daily Performance Tracker (PySpark / HDFS)
# =============================================================================
#
# PySpark equivalent of o2p_async_daily_tracker.sql
...
raw_tactic \
    ...
    .groupBy(
        ...
        F.trim(F.col("TACTIC_CELL_CD")).alias("tactic_cell_cd"),
    ) \
...
# =============================================================================
# Tactic population — mobile-only O2P clients
# =============================================================================
...
# =============================================================================
# GA4 ecommerce — O2P banner events
# =============================================================================
...
ga4_filtered = spark.read \
    ...
    .filter(
        ...
        F.col("it_item_name").isin(O2P_PROMO_NAMES) &
...
if JOIN_COL:
    ...
    xlsx_path = "/tmp/o2p_daily_tracker.xlsx"
    try:
    ...
    html_path = "/tmp/o2p_daily_tracker.html"
    table_html = df.to_html(index=False, border=0, classes="t")
    with open(html_path, "w", encoding="utf-8") as f:
        f.write(f"""<!DOCTYPE html>
<html><head><meta charset="utf-8"><title>O2P Daily Tracker</title>
<style>
...
<h2>O2P Async Banner — Daily Tracker</h2>
