...
# %% [21] VENDOR MONTHLY since 2024-01 - month x MNE x disposition (1 = send, 4 = unsub),
...
# %% [22] CPC MONTHLY since 2024-01 - standing 1012 counts per month-end by consent value
# (5002 explicit No + 5003 blank per Andre's ask; 5001 lands free). One server-side
# aggregate, no attribution - CPC carries no MNE.
cpc_m = pd.read_sql("""
