...
# %% [11] SUMMARY pointer - each number above IS the summary; windows stated per cell
...
print("red-team: R1 blank-mne identity (#3) | R2 optout recency (#12) | R3 flip-lag pipe test (#6)")
print("still outreach-only: switch mapping (c/d), SFMC-side re-subscribe (e) - no query answers those")
