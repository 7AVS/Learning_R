...
-- No code field is privileged as "the arm" — no confirmed cell-code lookup exists for AUH.
-- Rollups and labeling happen downstream once the lookup is validated.


-- Q1: Code interaction profile (no success join) — leads per full code combination
SELECT
    TACTIC_ID,
    TREATMT_STRT_DT,
    TREATMT_END_DT,
...
-- Q2: Full-grain rollup with success — leads and AU adds per full code combination
SELECT
    a.TACTIC_ID,
    a.TREATMT_STRT_DT,
    a.TREATMT_MN,
