...
-- it_item_id = 'i_' || Salesforce offer id — CONFIRMED 2026-06-11 (Q0 discovery, all 8 present;
-- bare it_promotion_id = 0 rows; ip_sf_campaign_mnemonic NOT in the _reduced table).
...
-- Run order: Q4 + Q5 diagnostics, Q1 main; Q2/Q3 once volumes known; Q6/Q7 validations.
