# =============================================================================
# O2P Async Banner — Daily Tracker (PySpark / HDFS)
# =============================================================================
# Jira: NBA-12268 | Live: April 13, 2026
# Join: t.CLNT_NO = b.up_srf_id2_value
# GA4 filter: it_item_id = 'i_298045'
...
try:
    ...
    daily_df.to_csv("/tmp/o2p_daily_tracker.csv", index=False)
    print("Saved: /tmp/o2p_daily_tracker.csv")
