"""VBA summary + 0-90 vintage — Reconciliation workstream.

Uses raw Casper + SCOT extracts (in-memory DataFrames vba_df / casper / scot).
Outputs vba_summary.csv + vba_vintage_curve.csv + a printed T/C cross-check.

This file is the methodologically transparent baseline. The deep-dive analytical
work — curated NBA table, UCP-business enrichment, portfolio enrichment, decision
tree — lives in `vba_deep_dive_cell.py`. Do not mix the two.
"""
