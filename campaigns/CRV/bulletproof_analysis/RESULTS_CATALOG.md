...
## Q28 — View-to-click journey (overlap_status × view_category) — RUN 2026-06-14

Source: pics/20260614_124912.jpg (chart summary) + pics/20260614_124924.jpg (raw table).

Populations from chart: overlap_action total 928,901 (viewer subset 882,907); overlap_control 45,994; no_overlap 380,959.

| overlap_status | view_category | clients | click_both | click_crv_only | click_pcl_only | click_neither |
|---|---|---|---|---|---|---|
| no_overlap | Both | 5,516 | 685 | 315 | 1,586 | 2,930 |
| no_overlap | CRV only | 982 | 0 | 159 | 0 | 823 |
| no_overlap | Neither | 160,885 | 0 | 1 | 70 | 160,814 |
| no_overlap | PCL only | 213,576 | 0 | 0 | 100,263 | 113,313 |
| overlap_action | Both | 492,476 | 71,537 | 17,141 | 104,037 | 299,761 |
| overlap_action | CRV only | 36,117 | 12 | 5,906 | 42 | 30,157 |
| overlap_action | Neither | 227,300 | 2 | 9 | 41 | 227,248 |
| overlap_action | PCL only | 127,014 | 26 | 10 | 24,171 | 102,807 |
| overlap_control | Both | 13 | 1 | 1 | 2 | 9 |
| overlap_control | CRV only | 2 | 0 | 0 | 0 | 2 |
| overlap_control | Neither | 13,471 | 0 | 0 | 8 | 13,463 |
| overlap_control | PCL only | 32,508 | 0 | 0 | 13,163 | 19,345 |

**Key derived reads:**
- View distribution (Action): Both 56% (492,476/882,907), PCL only 14% (127,014), CRV only 4% (36,117), Neither 26% (227,300). ~19% of overlap_action have no view row at all (928,901−882,907).
- Control viewers: 71% PCL-only (32,508/45,994) — almost no CRV views, as expected (CRV-Control are not served CRV). Only 13 control clients somehow in Both (0.03%) — effectively zero contamination.
- PCL click rates among Both-viewers: Action 104,037/492,476 = **21.1%**; Control 2/13 = noise. No-overlap PCL-only viewers: 100,263/213,576 = **47.0%**; Control PCL-only: 13,163/32,508 = **40.5%**.
- Chart summary click percentages (from 124912): Both-viewers → PCL click 12% (104,037), CRV click 8% (71,537 = dual-click); PCL-only viewers → 3% PCL click; CRV-only viewers → CRV click 2% (5,906/36,117 = 16.3% on CRV — chart shows 2% of total population). No-overlap summary: PCL click 26% (100,263), Control viewers PCL click 29% (13,163/45,994).
- FINDING: co-exposed (Both) clients show lower PCL click rate (21%) than no-overlap PCL viewers (47%) — CRV banner competes for the same click intent. Control viewers, who see only PCL, click at 40%. Consistent with the Q04 1.08pp suppression.

---

## s8 — GA4 view_promotion coverage by year/month — RUN 2026-06-14

Source: pics/20260614_134341.jpg (Starburst query; 17 rows, 502M rows/s, 46s elapsed).
Query: view_promotion events by year/month for the CRV/PCL banner id allowlist.

| year | month | n_view_events | n_clients |
|---|---|---|---|
| 2025 | 02 | 19,426,968 | 1,656,949 |
| 2025 | 03 | 21,624,882 | 1,644,337 |
| 2025 | 04 | 19,350,086 | 1,576,646 |
| 2025 | 05 | 21,480,834 | 1,676,590 |
| 2025 | 06 | 22,389,810 | 1,737,062 |
| 2025 | 07 | 23,099,052 | 1,713,544 |
| 2025 | 08 | 18,650,376 | 1,537,653 |
| 2025 | 09 | 17,521,039 | 1,441,212 |
| 2025 | 10 | 17,440,723 | 1,541,692 |
| 2025 | 11 | 23,029,988 | 1,802,125 |
| 2025 | 12 | 24,998,697 | 1,877,512 |
| 2026 | 01 | 23,774,581 | 1,855,094 |
| 2026 | 02 | 17,871,565 | 1,754,848 |
| 2026 | 03 | 20,538,690 | 1,770,562 |
| 2026 | 04 | 21,737,668 | 1,799,951 |
| 2026 | 05 | 25,112,543 | 1,837,721 |
| 2026 | 06 | 9,126,193 | 1,444,256 |

**Key findings:**
- GA4 coverage: **Feb 2025 – May 2026 complete** (full months); Jun 2026 partial (~mid-month at time of run 2026-06-14).
- Monthly event volume stable ~17–25M events/month; monthly unique clients ~1.4–1.9M.
- No gap months — continuous coverage across the full CRV analysis window (Oct 2024 data not in this query; earliest month here is Feb 2025; CRV analysis starts Oct 2024 — prior months may be in a different partition or not yet queried).
- Volume dip in Aug–Oct 2025 (17–18M) vs peak Nov–Dec 2025 / Jan 2026 (23–25M) — likely seasonal engagement pattern, not a data gap.
- This confirms the banner id allowlist generates consistent GA4 signal across the full overlap window used in Q24/Q28/Q30.

---

## Q24 (Dec'25-Feb'26 cohort) — PCL contact frequency × CRV overlap — RUN 2026-06-14

Source: pics/20260614_125115.jpg (Stmt1) + pics/20260614_125123.jpg (Stmt2).
NOTE: This is a NEW COHORT CUT (Dec'25-Feb'26 PCL treatmt_strt_dt) distinct from the full-window Q24 run on 2026-06-12 already in this catalog. Numbers differ materially; both are valid for their respective windows.

### Statement 1 (overlap_status | pcl_touch_bucket | clients | converters | clients_any_pcl_view | total_pcl_view_days)

| overlap_status | pcl_touch_bucket | clients | converters | clients_any_pcl_view | total_pcl_view_days |
|---|---|---|---|---|---|
| no_overlap | 1 | 72,691 | 43,615 | 44,199 | 210,220 |
| no_overlap | 2 | 59,652 | 27,037 | 37,381 | 238,800 |
| no_overlap | 3 | 42,939 | 15,188 | 27,051 | 199,589 |
| no_overlap | 4 | 34,800 | 6,412 | 20,395 | 169,453 |
| no_overlap | 5+ | 170,708 | 13,770 | 89,972 | 900,880 |
| overlap_action | 1 | 130,394 | 72,461 | 86,329 | 487,531 |
| overlap_action | 2 | 126,185 | 51,870 | 89,586 | 670,854 |
| overlap_action | 3 | 92,197 | 27,414 | 66,218 | 560,684 |
| overlap_action | 4 | 81,702 | 11,940 | 58,398 | 536,493 |
| overlap_action | 5+ | 451,811 | 29,595 | 318,507 | 3,462,823 |
| overlap_control | 1 | 7,004 | 4,178 | 4,724 | 24,697 |
| overlap_control | 2 | 6,701 | 2,896 | 4,804 | 34,437 |
| overlap_control | 3 | 4,735 | 1,508 | 3,439 | 29,004 |
| overlap_control | 4 | 4,232 | 632 | 3,049 | 29,151 |
| overlap_control | 5+ | 23,291 | 1,570 | 16,485 | 193,517 |

**Derived conversion rates (Action vs Control, Control−Action gap):**
- touch-1: Action 72,461/130,394 = **55.6%**; Control 4,178/7,004 = **59.6%** → gap **+4.0pp**
- touch-2: Action 51,870/126,185 = **41.1%**; Control 2,896/6,701 = **43.2%** → gap **+2.1pp**
- touch-3: Action 27,414/92,197 = **29.7%**; Control 1,508/4,735 = **31.8%** → gap **+2.1pp**
- touch-4: Action 11,940/81,702 = **14.6%**; Control 632/4,232 = **14.9%** → gap **+0.3pp** (near zero)
- touch 5+: Action 29,595/451,811 = **6.5%**; Control 1,570/23,291 = **6.7%** → gap **+0.2pp** (near zero)
HEADLINE: suppression concentrates in fresh targets (touch-1 to touch-3). Gap narrows to ~0 by touch-4+. Consistent with Q24 full-window result.

### Statement 2 (overlap_status | banner_contact_freq | clients | deployments_total | click_users | converters)

| overlap_status | banner_contact_freq | clients | deployments_total | click_users | converters |
|---|---|---|---|---|---|
| no_overlap | 0 | 161,792 | 195,898 | 70 | 32,740 |
| no_overlap | 1 | 182,094 | 190,135 | 87,808 | 69,454 |
| no_overlap | 2 | 36,904 | 73,808 | 14,684 | 3,828 |
| overlap_action | 0 | 263,251 | 317,408 | 97 | 55,781 |
| overlap_action | 1 | 479,297 | 499,838 | 157,859 | 127,319 |
| overlap_action | 2 | 139,741 | 279,482 | 41,753 | 10,180 |
| overlap_control | 0 | 13,462 | 16,294 | 8 | 2,897 |
| overlap_control | 1 | 25,335 | 26,322 | 10,501 | 7,377 |
| overlap_control | 2 | 7,166 | 14,332 | 2,655 | 510 |

**Derived banner-freq conversion rates (channel-side, Action vs Control at freq=1):**
- freq-1: Action 127,319/479,297 = **26.6%**; Control 7,377/25,335 = **29.1%** → gap **+2.5pp**
- freq-0 (no banner delivery): Action 55,781/263,251 = **21.2%**; Control 2,897/13,462 = **21.5%** → gap **~0** (organic conversion; banner delivery not needed for these clients)
- freq-2: Action 10,180/139,741 = **7.3%**; Control 510/7,166 = **7.1%** → gap ~0 (survivorship; already converted at freq-1)
IMPLICATION: the Action-vs-Control gap materializes exclusively in banner-reached clients (freq-1+). Non-reached clients convert at the same rate both arms — no carry-over suppression effect outside the banner window.

---

## Q30 — PCL saturation by arm (Dec'25-Feb'26 cohort) — RUN 2026-06-14

Source: pics/20260614_202947.jpg (Stmt1 — Starburst, 15 rows, 167M rows/s, 53s) + pics/20260614_203017.jpg (Stmt2 — Excel, view_day_bucket).
Purpose: test whether Action clients receive MORE PCL saturation (more deployments/view-days) explaining away the conversion gap — or whether gap is real.

### Statement 1 (overlap_status | pcl_touch_bucket | n_clients | converters | clients_any_pcl_view | total_pcl_view_days)

Identical columns and population to Q24 Dec'25-Feb'26 Stmt1 (same query structure, same cohort). Numbers match exactly — Q30 Stmt1 IS the Dec'25-Feb'26 cohort cut of Q24 Stmt1 (confirmed: same rows/values).

**Balance check:**
- overlap_action total = 882,289 clients; overlap_control = 45,963; no_overlap = 380,790.
- Control/Action ratio = 45,963/882,289 = 5.2% — consistent with ~5% CRV control split.
- clients_any_pcl_view as % of clients: Action touch-1 86,329/130,394 = **66.2%**; Control touch-1 4,724/7,004 = **67.4%** — BALANCED. PCL banner reach is equal arm-to-arm at every touch bucket.
- View-days per viewer: Action touch-1 487,531/86,329 = **5.6 days**; Control 24,697/4,724 = **5.2 days** — SIMILAR. Action clients are not getting more PCL view exposure to explain the conversion gap.
VERDICT: PCL saturation (reach + intensity) is balanced across Action and Control at every touch bucket. The 4.0pp conversion gap at touch-1 is NOT explained by differential PCL exposure — it is a real suppression effect.

### Statement 2 (overlap_status | view_day_bucket | n_clients | converters)

| overlap_status | view_day_bucket | n_clients | converters |
|---|---|---|---|
| no_overlap | 0 | 161,792 | 32,740 |
| no_overlap | 1 | 53,058 | 30,065 |
| no_overlap | 2 | 27,486 | 11,189 |
| no_overlap | 3 | 19,240 | 6,257 |
| no_overlap | 4 | 15,069 | 4,275 |
| no_overlap | 5 | 12,741 | 3,306 |
| no_overlap | 6-10 | 39,878 | 9,011 |
| no_overlap | 11-20 | 31,792 | 6,186 |
| no_overlap | 21+ | 19,734 | 2,993 |
| overlap_action | 0 | 263,251 | 55,781 |
| overlap_action | 1 | 98,742 | 44,204 |
| overlap_action | 2 | 66,207 | 20,373 |
| overlap_action | 3 | 54,269 | 13,080 |
| overlap_action | 4 | 45,877 | 9,646 |
| overlap_action | 5 | 40,283 | 7,731 |
| overlap_action | 6-10 | 134,823 | 21,961 |
| overlap_action | 11-20 | 110,248 | 14,348 |
| overlap_action | 21+ | 68,589 | 6,156 |
| overlap_control | 0 | 13,462 | 2,897 |
| overlap_control | 1 | 5,858 | 3,012 |
| overlap_control | 2 | 3,520 | 1,230 |
| overlap_control | 3 | 2,712 | 729 |
| overlap_control | 4 | 2,202 | 453 |
| overlap_control | 5 | 1,899 | 362 |
| overlap_control | 6-10 | 6,614 | 1,031 |
| overlap_control | 11-20 | 5,696 | 725 |
| overlap_control | 21+ | 4,000 | 345 |

**Key derived reads from Stmt2:**
- view_day=0 (no PCL banner views): Action 55,781/263,251 = **21.2%**; Control 2,897/13,462 = **21.5%** → gap **~0**. Non-viewers convert at same rate both arms — confirming gap mechanism requires banner exposure.
- view_day=1 (exactly 1 view-day): Action 44,204/98,742 = **44.8%**; Control 3,012/5,858 = **51.4%** → gap **+6.6pp** at first-view. This is the sharpest bucket.
- view_day=2: Action 20,373/66,207 = **30.8%**; Control 1,230/3,520 = **34.9%** → gap **+4.1pp**
- view_day=3: Action 13,080/54,269 = **24.1%**; Control 729/2,712 = **26.9%** → gap **+2.8pp**
- view_day=5: Action 7,731/40,283 = **19.2%**; Control 362/1,899 = **19.1%** → gap ~0 (converging)
- Across-bucket conversion slope (both arms): declining monotonically (clients who need more view-days to convert have lower baseline propensity). This is SELECTION not fatigue — read within-bucket arm gap (vertical), not the across-bucket slope (horizontal).
TAKEAWAY: suppression concentrates in the first few PCL banner view-days. Clients who see the banner once and are in the Action arm convert 6.6pp less than Control equivalents. The gap closes by view-day 5+ — consistent with high-propensity clients converting fast, remainder having lower propensity either way.

---

## STATUS (2026-06-14 additions)
- Q28 RUN 2026-06-14 (pics 124912/124924): view-to-click journey. Action dual-viewers (Both) = 492,476 (56% of banner viewers); PCL click rate 21.1% (Action Both) vs 40.5% (Control PCL-only). Co-exposure lowers PCL click rate materially. Zero meaningful control contamination in CRV view group (13 of 45,994 = 0.03%).
- s8 RUN 2026-06-14 (pic 134341): GA4 view_promotion coverage Feb 2025–May 2026 complete, Jun 2026 partial. ~17–25M events/month, ~1.4–1.9M unique clients/month. Stable; no gap months in analysis window.
- Q24 (Dec'25-Feb'26 cohort) RUN 2026-06-14 (pics 125115/125123): suppression +4.0pp at touch-1, +2.1pp at touch-2/3, ~0 at touch-4+. Banner-freq=1 gap +2.5pp Action vs Control; freq-0 gap ~0 (organic path equal both arms).
- Q30 RUN 2026-06-14 (pics 202947/203017): PCL saturation balanced (reach + view-days equal arm-to-arm at each touch bucket). Gap NOT explained by differential PCL exposure. View-day=1 gap = 6.6pp (sharpest bucket); closes by view-day 5+.
