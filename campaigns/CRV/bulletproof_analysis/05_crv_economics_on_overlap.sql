...
SELECT
    ...
    AVG(CAST(instl_txn_prncpl_amt AS DECIMAL(18,6)))                        AS mean_principal,
    PERCENTILE_DISC(0.10) WITHIN GROUP (ORDER BY instl_txn_prncpl_amt)      AS p10_principal,
    PERCENTILE_DISC(0.25) WITHIN GROUP (ORDER BY instl_txn_prncpl_amt)      AS p25_principal,
    PERCENTILE_DISC(0.50) WITHIN GROUP (ORDER BY instl_txn_prncpl_amt)      AS median_principal,
    PERCENTILE_DISC(0.75) WITHIN GROUP (ORDER BY instl_txn_prncpl_amt)      AS p75_principal,
    PERCENTILE_DISC(0.90) WITHIN GROUP (ORDER BY instl_txn_prncpl_amt)      AS p90_principal,
...
SELECT
    ...
    AVG(CAST(instl_txn_prncpl_amt AS DECIMAL(18,6))),
    PERCENTILE_DISC(0.10) WITHIN GROUP (ORDER BY instl_txn_prncpl_amt),
    PERCENTILE_DISC(0.25) WITHIN GROUP (ORDER BY instl_txn_prncpl_amt),
    PERCENTILE_DISC(0.50) WITHIN GROUP (ORDER BY instl_txn_prncpl_amt),
    PERCENTILE_DISC(0.75) WITHIN GROUP (ORDER BY instl_txn_prncpl_amt),
    PERCENTILE_DISC(0.90) WITHIN GROUP (ORDER BY instl_txn_prncpl_amt),
